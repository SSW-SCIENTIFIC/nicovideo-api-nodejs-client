...
var Live;
(function (Live) {
    function createLiveWatchRequest(liveId) {
        return {
            method: "GET",
    ...
    Live.createLiveWatchRequest = createLiveWatchRequest;
})(Live = exports.Live || (exports.Live = {}));
var Ranking;
(function (Ranking) {
    function createGetRankingRSSRequest(type, period, suffix) {
        return {
            method: "GET",
