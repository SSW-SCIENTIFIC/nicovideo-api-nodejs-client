...
class Video {
    ...
    async getVideoFromSmile(param) {
        ...
        return (await this.session.client.request(APIEntryPoints_1.Video.createDownloadFromSmileRequest(videoInfo.id, videoInfo.smileInfo.url))).data;
    }
    ...
    async getVideoFromDmc(param) {
        ...
        return (await this.session.client.request(APIEntryPoints_1.Video.createDownloadFromDmcRequest(id, session.content_uri))).data.on("close", () => clearInterval(intervalId));
    }
    async getVideoStreamFromDmc(param) {
        ...
        return (await this.session.client.request(APIEntryPoints_1.Video.createDownloadFromDmcRequest(watchAPIData.video.id, session.content_uri))).data.on("close", () => clearInterval(intervalId));
    }
    /**
     *
     * @param videoId
