...
(function (Session) {
     ...
     */
    function createMultiFactorAuthenticationRequest(url, oneTimePad, trust, deviceName) {
        return {
            method: "POST",
            url: url,
            data: {
    ...
    Session.createMultiFactorAuthenticationRequest = createMultiFactorAuthenticationRequest;
    /**
